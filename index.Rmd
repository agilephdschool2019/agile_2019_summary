...
- Version control with [Git](https://en.wikipedia.org/wiki/Git)

- [RStudio](https://rstudio.com/products/rstudio/) project management and Git integration

- RStudio and [R Markdown](https://rmarkdown.rstudio.com/) to combine reproducibility concepts from data processing, coding and document writing as a single workflow, so called [literate programming](https://en.wikipedia.org/wiki/Literate_programming).
...
All manuscripts and the proceedings repository are published on GitHub in the organisation [agilephdschool2019](https://github.com/agilephdschool2019/).
The [proceedings main repository](https://github.com/agilephdschool2019/agile_2019_phd_school_proceedings/) provides a boilerplate for future PhD schools.
